...
```{r}
extraction_efficiency_corrected_lineplot
extraction_efficiency_corrected_lineplot <- extraction_efficiency_corrected_lineplot%>% filter(experiment_name != 'Thermus_standard')
#extraction_efficiency_corrected_lineplot <- extraction_efficiency_corrected_lineplot%>% filter(experiment_name != 'MED4')


cluster_colors <- c(`1904_Alteromonas`= '#c63c26',`1907_Thalassospira`= '#C17DA5',`1940_Pseudohoeflea`='#EAC043',
                    `1943_Marinobacter`= '#59a9b7',`MED4`='#9ab54d',Community='#3a7db8')


metaG_plot<- ggplot(extraction_efficiency_corrected_lineplot, aes(x=sampling_day,y=`mean_absolute_counts`,fill=experiment_name)) + 
    geom_bar(position="fill", stat="identity",alpha=0.8,color='black')+
...
#Cairo(file = "/Users/jamesmullet/comm_dyn_metaG_rel_abund_without_pro_v1.svg", type = "svg", width = 35, height = 20, units = "in", dpi = 250)
#Cairo(file = "/Users/jamesmullet/comm_dyn_metaG_rel_abund_with_pro_v1.svg", type = "svg", width = 35, height = 20, units = "in", dpi = 250)
#print(metaG_plot)  # 'final_graph' is the ggplot object
#dev.off()
